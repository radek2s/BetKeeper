...
export const RequestStatusGuards = {
  isPending: (status: RequestStatus): boolean =>
    status === RequestStatus.PENDING,
  isApproved: (status: RequestStatus): boolean =>
    status === RequestStatus.APPROVED,
  isRejected: (status: RequestStatus): boolean =>
    status === RequestStatus.REJECTED,
  isCancelled: (status: RequestStatus): boolean =>
    status === RequestStatus.CANCELLED,
  isExpired: (status: RequestStatus): boolean =>
...
export const UserStatusGuards = {
  ...
  canSendFriendRequests: (status: UserStatus): boolean =>
